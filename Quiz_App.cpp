...
void display_5(QuizApp q5)
{
    ...
    cin >> user_answer_5;
    if(user_answer_5 != 2){
        cout << "Incorrect! The correct answer is Mars (Mt. Olympus Mons).";
    } else{
        cout << "Hey, that's correct! Mt. Olympus Mons is the tallest and widest/largest mountain (volcano) in the entire solar system with a height of over 21.9 kms.";
    }
}
...
int main()
{
    ...
    cout << "That's it! Exciting, wasn't it?" << endl;
