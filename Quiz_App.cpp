...
int main()
{
    ...
    cout << "This quiz is going to be interesting... Give it a try!\n";
    Sleep(2000);
    string reply;
    cout << "Shall we begin then? Press Y to proceed and N to withdraw from the quiz.\n";
    cin >> reply;
    while (true){
        if (reply == "Y" || reply == "y")
            break;
            ...
            cout << "Sorry, could you try again? Y - proceed and N - terminate.\n";
            cin >> reply;
        }
    }
    ...
    if (score == 5){
        cout << "\nHey, you answered all the questions correctly! You got a perfect score..." << endl;
        Sleep(100);
        cout << "GREAT JOB!" << endl;
    }else{
